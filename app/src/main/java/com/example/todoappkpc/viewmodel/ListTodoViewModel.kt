...
class ListTodoViewModel(application: Application) : AndroidViewModel(application), CoroutineScope {
    ...
    fun refresh() {
        ...
        launch {
            ...
            todoLD.postValue(db.todoDao().selectAllTodoDesc())
        }
    }
    ...
    fun clearTask(todo: Todo) {
        launch {
            ...
            todoLD.postValue(db.todoDao().selectAllTodoDesc()) //menggunakan postvalue agar di async karena record data banyak biar gak nunggu lama
        }
    }
